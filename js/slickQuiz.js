...
(function($){
    $.slickQuiz = function(element, options) {
        var plugin   = this,
            ...
            defaults = {
                checkAnswerText:  'Contestar la pregunta',
        ...
        plugin.method = {
            ...
            completeQuiz: function(options) {
                ...
                if (plugin.config.disableRanking) {
                    ...
                    var levels    = [
                                        quizValues.info.level1, // 93,75%
                                        quizValues.info.level2, // 87,5%
                                        quizValues.info.level3, // 81,25%
                                        quizValues.info.level4, // 75%
                                        quizValues.info.level5, // 68,75%
                                        quizValues.info.level6, // 62,5%
                                        quizValues.info.level7, // 56,25%
                                        quizValues.info.level8, // 50%
                                        quizValues.info.level9, // 43,75%
                                        quizValues.info.level10, // 37,5%
                                        quizValues.info.level11, // 31,25%
                                        quizValues.info.level12, // 25%
                                        quizValues.info.level13, // 18,75%
                                        quizValues.info.level14, // 12,5%
                                        quizValues.info.level15, // 6,25
                                        quizValues.info.level16 // 0
            ...
            calculateLevel: function(correctAnswers) {
                ...
                if (plugin.method.inRange(0, 0.06, percent)) {
                    level = 15;
                } else if (plugin.method.inRange(0.06, 0.11, percent)) {
                    level = 14;
                } else if (plugin.method.inRange(0.12, 0.17, percent)) {
                    level = 13;
                } else if (plugin.method.inRange(0.18, 0.23, percent)) {
                    level = 12;
                } else if (plugin.method.inRange(0.24, 0.30, percent)) {
                    level = 11;
                } else if (plugin.method.inRange(0.31, 0.36, percent)) {
                    level = 10;
                } else if (plugin.method.inRange(0.37, 0.42, percent)) {
                    level = 9;
                } else if (plugin.method.inRange(0.43, 0.48, percent)) {
                    level = 8;
                } else if (plugin.method.inRange(0.49, 0.55, percent)) {
                    level = 7;
                } else if (plugin.method.inRange(0.56, 0.61, percent)) {
                    level = 6;
                } else if (plugin.method.inRange(0.62, 0.67, percent)) {
                    level = 5;
                } else if (plugin.method.inRange(0.68, 0.73, percent)) {
                    level = 4;
                } else if (plugin.method.inRange(0.74, 0.82, percent)) {
                    level = 3;
                } else if (plugin.method.inRange(0.83, 0.88, percent)) {
                    level = 2;
